    ...
    <AuthenticatedProviders>
      <div className={cn("flex flex-1 items-stretch")}>
        <img
          ...
          className="absolute w-1/2 -top-40 -left-32 blur-3xl opacity-80"
        />
        <img
          src={"login_ilustration1.svg"}
          className="absolute w-1/3 top-auto -bottom-40 left-36 blur-3xl opacity-80"
        />
        <img
          src={"login_ilustration1.svg"}
        ...
        <img
          src={"login_ilustration1.svg"}
          className="absolute w-1/3 -right-40 -bottom-40  blur-3xl opacity-80"
        />
